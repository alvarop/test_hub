...
void gpio_init() {
  ...
  GPIO_Init(
      _DBG_LED_PORT,
      &(GPIO_InitTypeDef){(1 << _DBG_LED_PIN), GPIO_Mode_OUT, GPIO_Speed_2MHz,
                          GPIO_OType_PP, GPIO_PuPd_NOPULL});
  GPIO_Init(_LED1_PORT, &(GPIO_InitTypeDef){(1 << _LED1_PIN), GPIO_Mode_OUT,
                                            GPIO_Speed_2MHz, GPIO_OType_PP,
                                            GPIO_PuPd_NOPULL});
  GPIO_Init(_LED2_PORT, &(GPIO_InitTypeDef){(1 << _LED2_PIN), GPIO_Mode_OUT,
                                            GPIO_Speed_2MHz, GPIO_OType_PP,
                                            GPIO_PuPd_NOPULL});
  GPIO_Init(_LED3_PORT, &(GPIO_InitTypeDef){(1 << _LED3_PIN), GPIO_Mode_OUT,
                                            GPIO_Speed_2MHz, GPIO_OType_PP,
                                            GPIO_PuPd_NOPULL});
